...
#### 9. Cu clusters
The training set also includes different isomers of Cu clusters containing 2–50 atoms in a 30 Å x 30 Å x 30 Å simulation box, comprising a total of 120 configurations.

#### 10. Cu clusters on pristine hBN/SiC
The training set was further refined by including 21 configurations generated by randomly placing Cu atoms on top of pristine hBN/SiC.

<table border="1"><tr><td>
<strong>NOTE&nbsp;</strong>─ The finalized dataset consists of 4,686 entries, of which 4,094 (85%) were used for training and 592 (15%) reserved for testing.
</td></tr></table>
...
* **Test set:**
  – Energy: 6.5 meV/atom
  – Force: 79 meV/Å
  – Virial: 13.5 meV/atom

* **Training set:**
  – Energy: 8.3 meV/atom
  – Force: 81 meV/Å
  – Virial: 13.8 meV/atom

# The potential has been validated in the publications listed under `Citations`.
...
If you use this workflow or data in your research, please cite the following:
  - https://link.aps.org/doi/10.1103/lymz-nlbf
  - another arxived
}
